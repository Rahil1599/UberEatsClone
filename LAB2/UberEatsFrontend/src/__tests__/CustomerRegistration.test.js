...
const server = setupServer(
  rest.post('http://18.225.37.132:3001/uber-eats/api/customer/register', (req, res, ctx) => res(ctx.json([{ EmailId: 'rahil.shah2107@gmail.com' }]))),
);
...
describe('Restaurant Login Tests', () => {
  it('Users should be able to enter email id,password and name on the screen', async () => {
    ...
    expect(name.value).toBe('rahil.shah2107');
  });
