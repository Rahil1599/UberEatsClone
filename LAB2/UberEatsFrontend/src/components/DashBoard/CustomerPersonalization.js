...
import { setRestaurant } from '../../state/action-creators/restaurantActionCreator';
...
export default function CustomerPersonalization() {
  ...
  useEffect(async () => {
    ...
    const url = `${backendServer}/personalize/customer/${customer.CustomerId}`;
