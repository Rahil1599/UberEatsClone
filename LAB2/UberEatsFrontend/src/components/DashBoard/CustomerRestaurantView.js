...
import { updateCart } from '../../state/action-creators/cartActionCreator';
...
export default function CustomerRestaurantView() {
  ...
  const currentRestaurantDetails = useSelector((state) => state.restaurant.currentRestaurant);
  ...
  useEffect(async () => {
    ...
    const url = `${backendServer}/restaurant/${currentRestaurantDetails.RestaurantId}/dishes`;
